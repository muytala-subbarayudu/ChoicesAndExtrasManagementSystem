...
namespace ChoicesExtrasManagement.Migrations
{
    ...
    [Migration("20230829232154_SavedChoicesAdded")]
    partial class SavedChoicesAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChoicesExtrasManagement.Models.SavedChoice", b =>
                {
                    ...
                    b.Property<int>("PlotTypeRoomMappingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlotTypeRoomMappingId");
            ...
            modelBuilder.Entity("ChoicesExtrasManagement.Models.SavedChoice", b =>
                {
                    ...
                    b.HasOne("ChoicesExtrasManagement.Models.PlotTypeRoomMapping", "PlotTypeRoomMapping")
                        .WithMany()
                        .HasForeignKey("PlotTypeRoomMappingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
